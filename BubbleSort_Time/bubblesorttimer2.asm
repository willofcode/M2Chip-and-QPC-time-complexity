# william Ng
# the time complexity of the static array has 1000 random integers

	.data
array:  .word	 0:1000   # Example array to be sorted
...
main:
    ...
    li $a1, 1000      # Load the size of the array into $a1
